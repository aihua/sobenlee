...
\begin{exlist}
  \item $\int_\minf^\pinf\me^{-(x-a)^2}\dif x$，\quad\DingNum{1}\enspace$a<\alpha<b$；\quad\DingNum{2}\enspace$\alpha\in\mR$；
  \item $\int_0^1x^{p-1}\ln^2x\dif x$，\quad\DingNum{1}\enspace$p\geq p_0>0$；\quad\DingNum{2}\enspace$p>0$；
  \item $\int_0^\pinf\dfrac{\sin\alpha x}x\dif x$，\quad\DingNum{1}\enspace$\alpha\in\mintc ab$，且~
  $0\nin\mintc ab$；\quad\DingNum{2}\enspace$\alpha\in\mintc ab$，且~$0\in\mintc ab$；
