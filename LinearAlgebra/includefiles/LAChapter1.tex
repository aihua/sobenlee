...
\tablebox{}{\makebox[\ccwd][l]{\rotcaption{Euclid~长除法}\label{Euclid-chufa}}}
\tablebox[\ccwd]{}{\rule{.6pt}{.8\wd\EuclidChangchu}}
\tablebox{}{\rotatebox{90}{\usebox{\EuclidLiTi}}}
\tablebox{}{\makebox[\ccwd][l]{\rotcaption{Euclid~长除法（\ref{ltEuclid-chufa}）}\label{Euclid-chufa-LiTi}}}
\end{floatrow}
\end{table}
...
\item[]\rlap{\parbox[t]{\ecolstotalwidth}{这里的求和号表示对遍历自然
        数~$1,2,\dotsc,n$~的所有排列~$i_1,i_2,\dotsc,i_n$~求和．\strut}}
\end{enumitemcols}
