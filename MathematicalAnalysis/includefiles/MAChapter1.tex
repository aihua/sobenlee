...
\begin{figure}
\begin{floatrow}
\figurebox{\caption{奇函数}\label{fig:sec1.2-8}}{\somefigure}
\figurebox{\caption{偶函数}\label{fig:sec1.2-9}}{\somefigure}
\end{floatrow}
\end{figure}
...
而曲线不全落在两直线之间，意味着总有一点落在两直线之外。%%可用符号表示为，存在~$x'\in X$，使得~$\mabsb{f(x')}>M$。
...
\begin{figure}
\begin{floatrow}
\figurebox{\caption{常数函数}\label{fig:sec1.2-15}}{\somefigure}
\figurebox{\caption{幂函数}\label{fig:sec1.2-16}}{\somefigure}
\end{floatrow}
\newFRline
\begin{floatrow}
\figurebox{\caption{指数函数}\label{fig:sec1.2-17}}{\somefigure}
\figurebox{\caption{对数函数}\label{fig:sec1.2-18}}{\somefigure}
\end{floatrow}
\end{figure}
...
\begin{figure}
\begin{floatrow}
\figurebox{\caption{正弦函数}\label{fig:sec1.2-19}}{\somefigure}
\figurebox{\caption{余弦函数}\label{fig:sec1.2-20}}{\somefigure}
\end{floatrow}
\newFRline
\begin{floatrow}
\figurebox{\caption{正切函数}\label{fig:sec1.2-21}}{\somefigure}
\figurebox{\caption{余切函数}\label{fig:sec1.2-22}}{\somefigure}
\end{floatrow}
\end{figure}
...
\begin{figure}
\begin{floatrow}
\figurebox[1.1\FBwidth]{\caption{反正弦函数}\label{fig:sec1.2-23}}{\somefigure}
\figurebox[1.1\FBwidth]{\caption{反余弦函数}\label{fig:sec1.2-24}}{\somefigure}
\end{floatrow}
\newFRline
\begin{floatrow}
\figurebox[1.1\FBwidth]{\caption{反正切函数}\label{fig:sec1.2-25}}{\somefigure}
\figurebox[1.1\FBwidth]{\caption{反余切函数}\label{fig:sec1.2-26}}{\somefigure}
\end{floatrow}
\end{figure}
